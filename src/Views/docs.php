<div class="container pt-5 mt-5">
  <div class="row justify-content-center">
    <div class="col-sm-8 d-flex flex-column row-gap-3">
      <h1>Dokumentasi Studi Kasus</h1>
  ...
  <div class="row justify-content-center py-3 my-3">
    <div class="col-sm-8 d-flex flex-column row-gap-3">
      <h2>Normalisasi untuk atribut Cost</h2>
  ...
  <div class="row justify-content-center py-3 my-3">
    <div class="col-sm-8 d-flex flex-column row-gap-3">
      <h2>Normalisasi untuk atribut Benefit</h2>
