<div class="container d-flex flex-column row-gap-5 px-3">
  ...
  <div class="row justify-content-between py-5 mt-5">
    <div class="col-sm-4">
      ...
      <a href="" class="btn btn-outline-primary">Lihat perangkingan <i class="ri-sort-asc"></i></a>
    </div>
    <div class="col-sm-7">
      <div class="container">
          ...
          <?php foreach ($data["members"] as $member): ?>
            <div class="col-sm-6">
              <figure class="d-flex align-items-center column-gap-3">
                <img src="../../public/member/<?= $member["profile"] ?>" alt="<?= $member["name"] ?>" width="82" class="img-thumbnail rounded-circle">
